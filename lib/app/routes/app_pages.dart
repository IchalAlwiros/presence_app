...
import '../modules/all_presesensi/bindings/all_presesensi_binding.dart';
import '../modules/all_presesensi/views/all_presesensi_view.dart';
...
import '../modules/page_profile/bindings/page_profile_binding.dart';
import '../modules/page_profile/views/page_profile_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.ALL_PRESESENSI,
      page: () => AllPresesensiView(),
      binding: AllPresesensiBinding(),
    ),
  ];
}
